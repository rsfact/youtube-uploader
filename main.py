...
def main(file_path, title, upload_to_youtube):
    ...
    if file_extension in [".mp3", ".wav", ".aac"]:
        ...
        controller.process_video(video_path, title, upload_to_youtube)
    elif file_extension in [".mp4", ".mkv"]:
        controller.process_video(file_path, title, upload_to_youtube)
    else:
...
if __name__ == "__main__":
    ...
    main(file_path, title, upload_to_youtube)
